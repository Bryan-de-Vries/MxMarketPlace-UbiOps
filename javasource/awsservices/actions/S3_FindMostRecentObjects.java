 ...
 */
public class S3_FindMostRecentObjects extends CustomJavaAction<java.util.List<IMendixObject>>
{
	...
	public S3_FindMostRecentObjects(IContext context, IMendixObject credentials, java.lang.String bucket, java.lang.String prefix, java.lang.String pattern, java.lang.Long limit)
	{
		super(context);
	...
	public java.util.List<IMendixObject> executeAction() throws Exception
	{
		...
		while (true) {
			...
			for (software.amazon.awssdk.services.s3.model.S3Object obj : res.contents()) {
				if (pattern == null || 
						S3Helper.getFilenameFromKey(obj.key()).matches(pattern)) {
					result.add(S3Helper.getMxS3Object(getContext(), obj, bucket));
				}
			}
	...
	{
		return "S3_FindMostRecentObjects";
	}
