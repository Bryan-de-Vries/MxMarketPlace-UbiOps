...
/**
 * Actually a copy and delete combined.
 * AWS doesn't have a SDK call for move.
 */
public class S3_CopyObject extends CustomJavaAction<java.lang.Boolean>
{
	...
	public S3_CopyObject(IContext context, IMendixObject credentials, java.lang.String sourceBucket, java.lang.String sourceKey, java.lang.String destinationBucket, java.lang.String destionationKey)
	{
		super(context);
